...
def draw_pic(figsizex,figsizey,draw_dict):
	...
	for key in draw_dict:
		...
		linewidth = 4 if key in ('sum_static','distinct_sum_static') else 2
		y = draw_dict[key]
		print y
...
plt.plot(x,y,label="test1",color="yellowgreen",linewidth=2)
plt.plot(x,z,label="test2",color="turquoise",linewidth=2)
